<template>
  <div class="modal-update component">
    <div class="is-center">
      <p class="title">Actualizar Ahorros</p>
      <hr>
    </div>
    ...
    <div class="card-content">
      ...
      <div class="columns">
        <div class="column">
          <b-button type="is-danger" @click="updateSavings">Actualizar Ahorros</b-button>
        </div>
      </div>
...
export default {
  ...
  methods: {
    updateSavings() {
      ...
      UserService.updateSavings(this.email, this.updateAmount, this.description)
      .then(resp => {
        console.log(resp)
        this.$buefy.toast.open({
          duration: 5000,
          message: 'Se actualizaron los ahorro!',
          position: 'is-bottom',
          type: 'is-success'
        })
